class UsersController < ApplicationController
  ...
  USERNAME = "root" # needed to access the APi
  PASSWORD = "moisesxps" # needed to access the APi
  API_BASE_URL = "http://127.0.0.1:8000/api" # base url of the API
  ...
  def index
    ...
    # will get back you all the detail in json format, but it
